...
- `pnpm dlx storybook automigrate --config-dir apps/storybook/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/aria/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/ariakit/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/ark/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/base-ui/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/primitives/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/radix/.storybook`

- `pnpm dlx storybook automigrate --config-dir packages/react/.storybook`
