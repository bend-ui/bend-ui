...
- `npx storybook automigrate --config-dir apps/storybook/.storybook`

- `npx storybook automigrate --config-dir packages/aria/.storybook`

- `npx storybook automigrate --config-dir packages/ariakit/.storybook`

- `npx storybook automigrate --config-dir packages/ark/.storybook`

- `npx storybook automigrate --config-dir packages/base-ui/.storybook`

- `npx storybook automigrate --config-dir packages/primitives/.storybook`

- `npx storybook automigrate --config-dir packages/radix/.storybook`

- `npx storybook automigrate --config-dir packages/react/.storybook`
