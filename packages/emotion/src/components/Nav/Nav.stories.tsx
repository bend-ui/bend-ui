...
export const Usage: StoryObj<typeof Nav> = {
  render: (args) => (
    <Nav {...args}>
...
export const Vertical: StoryObj<typeof Nav> = {
  render: (args) => (
    <Nav {...args}>
      <Nav.Link aria-current="page">Home</Nav.Link>
      <Nav.Link>Dashboard</Nav.Link>
...
export const WithIcons: StoryObj<typeof Nav> = {
  render: (args) => (
    <Nav {...args}>
...
export const WithDropdown: StoryObj<typeof Nav> = {
  render: (args) => (
    <Nav {...args}>
      <Nav.Link aria-current="page" icon={<TbHome2 />}>
        Home
...
export const KitchenSink: StoryObj<typeof Nav> = {
  render: (args) => (
    <Nav {...args}>
      <Nav.Link
        aria-current="page"
