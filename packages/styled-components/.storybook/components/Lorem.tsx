...
export const Lorem = (props: LoremProps) => {
  const { lines = 1 } = props;

  const dummyText = Array.from({ length: lines }, (_, i) => i);
    ...
    <>
      {dummyText.map((_, i) => (
        <p key={`lorem-${i}`}>
          ...
          That&apos;s us. On it everyone you love, everyone you know, everyone
