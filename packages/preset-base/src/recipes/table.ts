...
export const table = defineSlotRecipe({
  ...
  variants: {
    ...
    withColumnBorder: {
      true: {
        head: { borderRight: 'border.weak' },
        headerCell: { borderRight: 'border.weak' },
        cell: { borderRight: 'border.weak' },
      },
    },
    withRowBorder: {
      true: {
        head: { borderBottom: 'border.weak' },
        headerCell: { borderBottom: 'border.weak' },
        cell: { borderBottom: 'border.weak' },
      },
    },
  },
  defaultVariants: {
