...
export type ClipboardRootProps = Assign<HTMLStyledProps<'div'>, ClipboardPrimitive.RootProps>
...
export type ClipboardLabelProps = Assign<HTMLStyledProps<'label'>, ClipboardPrimitive.LabelProps>
const ClipboardLabel = withParts<ClipboardLabelProps>(
  ClipboardPrimitive.Label,
  'label',
);

export type ClipboardControlProps = Assign<HTMLStyledProps<'div'>, ClipboardPrimitive.ControlProps>
const ClipboardControl = withParts<ClipboardControlProps>(
  ClipboardPrimitive.Control,
  'control',
);

export type ClipboardInputProps = Assign<HTMLStyledProps<'input'>, ClipboardPrimitive.InputProps>
const ClipboardInput = withParts<ClipboardInputProps>(
  ClipboardPrimitive.Input,
  'input',
);

export type ClipboardTriggerProps = Assign<HTMLStyledProps<'button'>, ClipboardPrimitive.TriggerProps>
const ClipboardTrigger = withParts<ClipboardTriggerProps>(
  ClipboardPrimitive.Trigger,
  'trigger',
);

export type ClipboardIndicatorProps = Assign<HTMLStyledProps<'div'>, ClipboardPrimitive.IndicatorProps>
