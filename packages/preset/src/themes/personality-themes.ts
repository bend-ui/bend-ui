...
export const createPersonalityColorSemanticTokens = (
...
const createPersonalityTheme = (
  ...
  semanticTokens: {
    colors: createPersonalityColorSemanticTokens(personality),
    fonts: {
    ...
    sizes: {
      ...
      scrollbar: { value: personality.density.spacing.md },
    },
    spacing: {
