...
Hosts shared component factories (e.g. `createAppShell`) that adapters wire to their upstream primitives. Consumers should import finished components from `@bend-ui/base-ui`, `@bend-ui/ark-ui`, etc.
